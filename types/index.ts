...
export type ReconciliationStatus = 'pending' | 'matched' | 'unmatched' | 'discrepancy' | 'resolved' | 'archived'
...
export type ComparisonOperator = 'equals' | 'not_equals' | 'contains' | 'starts_with' | 'ends_with' | 'greater_than' | 'less_than' | 'between' | 'in' | 'not_in'
...
export type AuditAction = 'create' | 'read' | 'update' | 'delete' | 'export' | 'import' | 'approve' | 'reject' | 'comment' | 'assign' | 'unassign'
...
export type RelationshipType = 'parent' | 'child' | 'sibling' | 'related' | 'duplicate' | 'conflict'
...
export type CaseStatus = 'open' | 'assigned' | 'in_progress' | 'pending_review' | 'resolved' | 'closed'
...
export type ChartType = 'bar' | 'line' | 'pie' | 'area' | 'scatter' | 'heatmap' | 'sankey' | 'treemap' | 'gauge' | 'funnel'

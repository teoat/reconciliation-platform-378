...
const configSchema = z.object({
  ...
  passwordMaxLength: z.string().default('128'),
  passwordExpirationDays: z.string().default('90'),
  passwordInitialExpirationDays: z.string().default('7'),
  passwordHistoryLimit: z.string().default('5'),
  passwordWarningDays: z.string().default('7'),
...
const rawConfig = {
  ...
  passwordInitialExpirationDays: process.env.PASSWORD_INITIAL_EXPIRATION_DAYS,
  passwordHistoryLimit: process.env.PASSWORD_HISTORY_LIMIT,
  passwordWarningDays: process.env.PASSWORD_WARNING_DAYS,
...
export const config = {
  ...
  passwordMaxLength: parseInt(parsedConfig.passwordMaxLength, 10),
  passwordExpirationDays: parseInt(parsedConfig.passwordExpirationDays, 10),
  passwordInitialExpirationDays: parseInt(parsedConfig.passwordInitialExpirationDays, 10),
  passwordHistoryLimit: parseInt(parsedConfig.passwordHistoryLimit, 10),
  passwordWarningDays: parseInt(parsedConfig.passwordWarningDays, 10),

    ...
    build: {
      ...
      terserOptions: {
        compress: {
          ...
          passes: 3, // Even more aggressive compression
          unsafe: true, // Enable unsafe optimizations for smaller bundle
          unsafe_comps: true, // Enable unsafe comparisons
          unsafe_Function: true, // Enable unsafe Function
          unsafe_math: true, // Enable unsafe math
          unsafe_symbols: true, // Enable unsafe symbols
          unsafe_methods: true, // Enable unsafe methods
          unsafe_proto: true, // Enable unsafe prototype
          unsafe_regexp: true, // Enable unsafe regexp
        },
        mangle: {

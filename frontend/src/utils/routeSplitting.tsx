...
export const ProjectDetailPage = createLazyRoute(() => import('../components/pages/ProjectDetailPage'))

// Reconciliation routes
export const ReconciliationPage = createLazyRoute(() => import('../components/pages/ReconciliationPage'))
export const ReconciliationDetailPage = createLazyRoute(() => import('../components/pages/ReconciliationDetailPage'))

// Ingestion routes
export const IngestionPage = createLazyRoute(() => import('../components/pages/IngestionPage'))
export const IngestionDetailPage = createLazyRoute(() => import('../components/pages/IngestionDetailPage'))
...
export const OrganizationPage = createLazyRoute(() => import('../components/pages/OrganizationPage'))

// Admin routes
export const AdminPage = createLazyRoute(() => import('../components/pages/AdminPage'))
export const UserManagementPage = createLazyRoute(() => import('../components/pages/UserManagementPage'))

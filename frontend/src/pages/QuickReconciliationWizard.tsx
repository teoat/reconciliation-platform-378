            ...
            <div className="space-y-2 text-sm">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium text-blue-900">
                  {Math.round(config.matchingThreshold * 100)}%
                </span>
              </div>
              <div className="flex justify-between">
  ...
  return (
    <>
      ...
      <main id="main-content" className="max-w-4xl mx-auto">
        ...
        {/* Progress Bar */}
        <div className="mb-8">
          <ProgressBar value={progress} variant="success" size="lg" />
          <div className="flex justify-between mt-2 text-sm text-gray-600">
            {steps.map((step) => (
              <div key={step.id} className="flex flex-col items-center">
                ...
                />
                <span
                  className={`mt-1 ${currentStep >= step.id ? 'text-blue-600 font-medium' : 'text-gray-400'}`}
                >
                  {step.id}
                </span>
              </div>

...
export const CardGrid: React.FC<CardGridProps> = ({
  ...
  return (
    <ResponsiveGrid cols={cardsPerRow} gap="lg" className={className}>
      {children}
    </ResponsiveGrid>
  );
};
...
export const ResponsiveText: React.FC<ResponsiveTextProps> = ({
  ...
  const textClasses = [responsiveSizeClasses, weightClasses[weight], colorClasses[color], className]
    .filter(Boolean)
    .join(' ');
...
export const ResponsiveVisibility: React.FC<ResponsiveVisibilityProps> = ({
  ...
  const visibilityClasses = [hideClasses, showClasses, className].filter(Boolean).join(' ');

...
const FrenlyOnboarding: React.FC<FrenlyOnboardingProps> = ({
  ...
  const onboardingSteps: OnboardingStep[] = [
    ...
    },
    {
      ...
      content: "I can help you with project management, data ingestion, reconciliation, and much more! I'll provide tips, celebrate your successes, and warn you about potential issues. Think of me as your personal reconciliation buddy! 🤖",
      duration: 5000,
      expression: {
        eyes: 'excited',
        mouth: 'big-smile',
    ...
    },
    {
      ...
      content: "I'll be with you every step of the way! I'll show you contextual tips, help you understand what to do next, and celebrate when you complete tasks. Just look for my speech bubbles and progress indicators! 🎯",
      duration: 4500,
      expression: {
        eyes: 'wink',
        mouth: 'smile',
    ...
    },
    {
      ...
      content: "You can click my avatar to get help anytime, minimize me if you need more space, or adjust my settings. I'll remember your preferences and adapt to your working style. Ready to start our adventure together? 🚀",
      duration: 5000,
      expression: {
        eyes: 'happy',
        mouth: 'smile',

  ...
  const runApiTest = useCallback(
    async (endpoint: string, method: string, _body?: Record<string, unknown> | unknown[]) => {
      ...
      try {
        ...
        setTestResults((prev) =>
          prev.map((result) => (result.timestamp === timestamp ? successResult : result))
        );
        ...
        <Card>
          <div className="p-6">
            ...
            <div className="flex items-center space-x-4">
              ...
              <Button variant="outline" onClick={handleRunAllTests} disabled={isRunning}>
          ...
          <Card>
            <div className="p-6">
              <div className="flex items-center justify-between mb-4">
                ...
                <Button size="sm" variant="outline" onClick={() => copyToClipboard(responseBody)}>

  ...
  return (
    <div className={`w-full ${className}`}>
      ...
      >
        ...
        <p id="dropzone-help" className="text-sm text-gray-500">
      ...
      {uploadSessions.size > 0 && (
        <div className="mt-4 space-y-2">
          ...
          <div
            ...
            aria-valuemin={0}
            aria-valuemax={100}
            aria-label={`Upload progress: ${getTotalProgress()}% complete`}
          >
            <div
          ...
          {Array.from(uploadSessions.values()).map((session) => (
            ...
            >
              ...
              <button
                ...
                aria-label={`Remove ${session.fileName} from upload queue`}
              >
                <X className="h-4 w-4" />
              </button>
            </div>

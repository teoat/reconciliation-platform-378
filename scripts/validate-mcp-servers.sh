...
test_npx_package "@executeautomation/playwright-mcp-server" "Playwright MCP"
test_npx_package "@modelcontextprotocol/server-sequential-thinking" "Sequential Thinking MCP"
test_npx_package "@modelcontextprotocol/server-memory" "Memory MCP"

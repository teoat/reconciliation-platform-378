...
use crate::models::schema::{
    audit_logs, data_sources, projects, reconciliation_jobs, reconciliation_results, users,
};
...
impl AnalyticsCollector {
    ...
    pub fn get_recent_activity(
        &self,
        conn: &mut diesel::PgConnection,
    ) -> AppResult<Vec<ActivityItemQueryResult>> {
    ...
    pub fn get_user_activity_counts(
        &self,
        user_id: Uuid,
        conn: &mut diesel::PgConnection,
    ) -> AppResult<(i64, i64, i64, i64)> {
    ...
    pub fn get_user_daily_activity_dates(
        &self,
        user_id: Uuid,
        conn: &mut diesel::PgConnection,
        ...
        let activities = audit_logs::table
            ...
            .select(diesel::dsl::sql::<diesel::sql_types::Date>(
                "DATE(created_at)",
            ))

...
impl JsonSchemaValidator {
    ...
    fn validate_string(
        ...
        let string_value = data.as_str().ok_or_else(|| {
            AppError::Validation("Failed to extract string value".to_string())
        })?;
    ...
    fn validate_number(
        ...
        let number_value = data.as_f64().ok_or_else(|| {
            AppError::Validation("Failed to extract number value".to_string())
        })?;
    ...
    fn validate_integer(
        ...
        let int_value = data.as_i64().ok_or_else(|| {
            AppError::Validation("Failed to extract integer value".to_string())
        })?;

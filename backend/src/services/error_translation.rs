...
impl ErrorTranslationService {
    ...
    pub fn new() -> Self {
        ...
        translations.insert(
            ...
            ErrorTranslation {
                ...
                suggestion: Some(
                    "Check that your email address is formatted correctly".to_string(),
                ),
                category: ErrorCategory::Validation,
            },
        );
        ...
        translations.insert(
            ...
            ErrorTranslation {
                ...
                suggestion: Some(
                    "Try again in a moment or contact support if the problem persists".to_string(),
                ),
                category: ErrorCategory::Network,
            },
        );
        ...
        translations.insert(
            ...
            ErrorTranslation {
                ...
                suggestion: Some(
                    "Try using a different name or check if the item already exists".to_string(),
                ),
                category: ErrorCategory::Database,
            },
        );
        ...
        translations.insert(
            ...
            ErrorTranslation {
                ...
                suggestion: Some(
                    "Try uploading a smaller file or contact support for assistance".to_string(),
                ),
        ...
        translations.insert(
            ...
            ErrorTranslation {
                ...
                suggestion: Some(
                    "Try a different payment method or add funds to your account".to_string(),
                ),
                category: ErrorCategory::Payment,
            },
        );
        ...
        translations.insert(
            ...
            ErrorTranslation {
                ...
                suggestion: Some(
                    "Please try again in a few moments or contact support".to_string(),
                ),
        ...
        let (code, custom_message) = match db_error {
            ...
            diesel::result::Error::DatabaseError(kind, info) => match kind {
                ...
                diesel::result::DatabaseErrorKind::ForeignKeyViolation => (
                    "FOREIGN_KEY_ERROR",
                    Some("This item is being used elsewhere and cannot be deleted".to_string()),
                ),
                ...
                _ => (
                    "DATABASE_ERROR",
                    Some("There was a problem with the database".to_string()),
                ),
            },
    ...
    pub fn should_retry(&self, error_code: &str) -> bool {
        matches!(
            self.get_error_category(error_code),

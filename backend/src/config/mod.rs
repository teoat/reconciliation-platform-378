    ...
    pub fn from_env() -> Result<Self, crate::errors::AppError> {
        ...
        Ok(Config {
            ...
            jwt_expiration: env::var("JWT_EXPIRATION")
                ...
                .parse()
                .map_err(|_| crate::errors::AppError::Config("Invalid JWT_EXPIRATION value".to_string()))?,
            ...
            max_file_size: env::var("MAX_FILE_SIZE")
                ...
                .parse()
                .map_err(|_| crate::errors::AppError::Config("Invalid MAX_FILE_SIZE value".to_string()))?, // 10MB
